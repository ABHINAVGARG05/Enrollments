      ...
      {selectedSubDomain !== "" && (
        <div className="w-full mt-8 h-full flex flex-col gap-8 md:gap-4">
          {filteredTasks.map((task, index) => (
            ...
            >
              <p className={`title ${task.label === "3d" || task.label === "video" ? "text-center w-full" : ""}`}>{task.title}</p>
...
const designTaskData: Task[] = [
  {
    "label": "ui",
    "title": "Designing a Personalized, Adaptive Learning Experience Through UI/UX",
  ...
  {
    "label": "ui",
    "title": "LinkedIn Reimagined: A Swipe-First Professional Networking Experience",
