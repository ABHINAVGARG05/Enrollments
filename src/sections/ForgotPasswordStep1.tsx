...
const ForgotPassword = () => {
  ...
  const isValidRegno = /^(23|24|25)[BM][A-Z]{2}\d{4}$/;
  ...
  return (
    <div className="w-full flex-grow h-[100vh] md:h-full relative flex justify-center items-center text-dark pt-0 px-4 md:p-12">
      {openToast && (
        <CustomToast
